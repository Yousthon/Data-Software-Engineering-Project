...
public class SiteDeParisMetier {
	...
	/**
	 * Methode verifiant la validité du password du Joueur.
	 * 
	 * @param passwordGestionnaire le password du gestionnaire à verifier
	 * 
	 * @throws MetierException levée si le <code>passwordJoueur</code> est invalide.
	 */
	...
	/**
	 * Methode de validation de la somme en jetons lors d'une operationd de
	 * credit/débit
	 * 
	 * @param somme la somme en jetons
	 * 
	 * @throws MetierException levée si la <code>somme</code> est négative.
	 */
	...
	/**
	 * Methode de validation du pseudo du joueur
	 * 
	 * @param pseudo le pseudo du joueur
	 * 
	 * @throws JoueurException levée si le <code>pseudo</code> n'est pas conforme.
	 */
	...
	/**
	 * Methode de validation du Nom et du Prenom du joueur
	 * 
	 * @param mot le nom ou le prenom du joueur
	 * 
	 * @throws JoueurException levée si le <code>mot</code> n'est pas conforme.
	 */
	...
	/**
	 * Seconde methode de validation du password du gestionnaire, utilisée dans un
	 * autre contexte que la première
	 * 
	 * @param passwordGestionnaire le password du Gestionnaire
	 * 
	 * @throws MetierException levée si le <code>password</code> n'est pas conforme.
	 */
	...
	/**
	 * Methode de validation du Nom d'un compétiteur ou d'une competition
	 * 
	 * @param mot le nom en question
	 * 
	 * @throws CompetitionException levée si le <code>mot</code> n'est pas valide.
	 */
	...
	/**
	 * Methode de validation de la date d'une competition (date depassée ou non
	 * instanciée)
	 * 
	 * @param dateCloture la date de cloture des inscriptions à la competition
	 * 
	 * @throws CompetitionException levée si la <code>dateCloture</code> n'est pas
	 *                              valide.
	 */
	...
	/**
	 * Methode de validation de la liste des competiteurs d'une competition
	 * 
	 * @param liste la liste des competiteurs
	 * 
	 * @throws MetierException      levée si la liste des competiteurs est non
	 *                              instanciée
	 * @throws CompetitionException levée s'il y a moins de deux competiteurs
	 */
